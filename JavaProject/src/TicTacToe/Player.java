    ...
    public void player(Stage stage)
    {
        ...
        b2.setOnAction(new EventHandler<ActionEvent>() {
            public void handle(ActionEvent event)
            {
                ...
                else if(tf1.getText().length()==0&&tf2.getText().length()==0)
                {
                    l3.setText("Please enter player names");
                }
                else if(tf1.getText().length()==0)
                {
                    l3.setText("Please enter player1 name");
                }
                else if(tf2.getText().length()==0)
                {
                    l3.setText("Please enter player2 name");
                }
            }
        });
